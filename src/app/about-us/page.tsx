...
export const metadata: Metadata = {
  ...
  description: 'Learn about 3 Patti Blue, our history, mission, and vision for creating the best card gaming platform in Pakistan with Teen Patti, Rummy and more.',
  keywords: ['3 Patti Blue about', 'about us', 'gaming company Pakistan', '3 Patti Blue history', 'card gaming platform', 'Teen Patti', '3 Patti'],
  robots: {
    index: true,
    follow: true,
    googleBot: {
  ...
  alternates: {
    canonical: "https://3pattiblue.pk/about-us",
  },
  openGraph: {
    title: 'About 3 Patti Blue - Pakistan\'s Premier Card Gaming Platform',
    description: 'Learn about 3 Patti Blue, our history, mission, and vision for creating the best card gaming platform in Pakistan with real cash rewards.',
    url: "https://3pattiblue.pk/about-us",
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "About 3 Patti Blue - Premier Card Gaming Platform",
      }
    ],
  },
  twitter: {
    ...
    title: 'About 3 Patti Blue - Pakistan\'s Premier Card Gaming Platform',
    description: 'Learn about 3 Patti Blue, our history, mission, and vision for creating the best card gaming platform in Pakistan with real cash rewards.',
    images: ["https://3pattiblue.pk/3-patti-blue-logo.webp"],
  },
};
        ...
        <div className="max-w-4xl mx-auto">
              ...
              <div className="md:w-2/3 md:pl-4 lg:pl-6">
                <div className="prose prose-lg max-w-none">
                  <p className="text-lg text-gray-300 leading-relaxed mb-6">
                    Welcome to <a href="https://www.3pattiblue.pk/" className="text-accent hover:text-accent font-semibold" target="_blank" rel="noopener noreferrer">www.3pattiblue.pk</a>, a trusted platform to provide the latest information about 3patti <Link href="/" className="text-accent hover:underline font-semibold">3 Patti Blue</Link>. This is one of the most popular online casino games in Pakistan, having <span className="font-bold text-accent">500K+ users</span>. <a href="https://pk3pattiblue.com/?from_gameid=7852455&channelCode=100000" target="_blank" rel="noopener noreferrer" className="text-accent hover:underline font-semibold">Download 3 Patti Blue</a> now to join thousands of players earning real cash rewards.
                  </p>
          ...
          <div className="bg-gradient-to-r from-orange-600 to-orange-500 rounded-2xl shadow-xl p-8 md:p-12 mb-12">
            ...
            <p className="text-lg md:text-xl text-white leading-relaxed text-center">
              Our aim is to provide the users with the latest and updated information and earning tips about 3 Patti Blue. For any type of information or query, you can visit our <Link href="/contact-us" className="underline hover:text-orange-100 font-semibold">contact us page</Link>.
            </p>
          </div>
          ...
          <div className="bg-secondary rounded-2xl shadow-xl p-8 text-center">
            ...
            <p className="text-gray-300 mb-6 text-lg">
              We're here to help! Contact our team for any information or queries about 3 Patti Blue.
            </p>
            <Link 
              href="/contact-us" 
