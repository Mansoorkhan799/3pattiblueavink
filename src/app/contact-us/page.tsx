...
export const metadata: Metadata = {
  title: 'Contact Us - 3 Patti Blue | Get Help & Support',
  description: 'Contact 3 Patti Blue support team for help with the app, content, privacy policy, and more. We are here to assist you.',
  keywords: 'contact 3 Patti Blue, 3 Patti Blue support, 3 Patti Blue email, customer support, help 3 Patti Blue',
  openGraph: {
    title: 'Contact Us - 3 Patti Blue',
    description: 'Get in touch with 3 Patti Blue support team for any queries or assistance.',
    url: 'https://3pattiblue.pk/contact-us',
  ...
  alternates: {
    canonical: 'https://3pattiblue.pk/contact-us',
  },
  robots: {
    index: true,
    follow: true,
        ...
        <div className="max-w-4xl mx-auto">
            ...
            <div className="prose prose-lg max-w-none">
              ...
              <div className="bg-secondary rounded-xl p-6 md:p-8 border-2 border-orange-200 overflow-hidden">
                ...
                <div className="flex justify-center w-full min-w-0 overflow-hidden px-4">
                  <a
                    href="mailto:roberthenry5426@gmail.com"
                  ...
                  >
                    ...
                    <span className="break-all">roberthenry5426@gmail.com</span>
                  </a>
                </div>
              </div>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="bg-secondary rounded-xl shadow-lg p-6 text-center hover:shadow-2xl transition-shadow duration-300">
              ...
              <p className="text-gray-400 mb-4">Need help with the 3 Patti Blue app?</p>
